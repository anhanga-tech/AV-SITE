...
---
> **Para o Codex:** Siga o checklist acima e documente qualquer variável de ambiente necessária no `.env.example`.
> **Para o Claude Bot:** Verificar se segredos não estão expostos no código e se a configuração segue as boas práticas de segurança.
