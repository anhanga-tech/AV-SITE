...
import { BETO_FAQ_ITEMS } from './betoFaqItems';
import { useFaqAccordion } from '../shared/useFaqAccordion';
import { ChevronDown, HelpCircle, Sparkles } from 'lucide-react';

const BetoCarreroFaq: React.FC = () => {
  const accordionItems = useFaqAccordion(BETO_FAQ_ITEMS);
