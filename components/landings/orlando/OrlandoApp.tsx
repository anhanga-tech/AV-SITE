...
// --- Constants ---
const WHATSAPP_URL = "https://wa.me/551152833309?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20os%20pacotes%20para%20Orlando.";
    ...
    <div className="landing-orlando">
      ...
      <main className="hero">
          <div className="hero-content">
              ...
              <div className="cta-container">
                  <a href={WHATSAPP_URL} className="btn-whatsapp main-btn" target="_blank" rel="noopener noreferrer">
      ...
      <section className="parks-gallery" id="parks">
        ...
        <div className="gallery-cta">
             <a href={WHATSAPP_URL} className="btn-whatsapp main-btn secondary" target="_blank" rel="noopener noreferrer">
                Ver Pacotes
             </a>
        </div>
      </section>
