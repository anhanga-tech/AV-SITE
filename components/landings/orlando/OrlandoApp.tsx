    ...
    <div className="landing-orlando">
      ...
      <main className="hero">
          <div className="hero-content">
              ...
              <div className="cta-container">
                  <a href={WHATSAPP_URL} className="main-btn" target="_blank" rel="noopener noreferrer">
      ...
      <section className="parks-gallery" id="parks">
        ...
        <div className="gallery-cta">
             <a href={WHATSAPP_URL} className="main-btn secondary" target="_blank" rel="noopener noreferrer">
                Ver Pacotes
             </a>
        </div>
      </section>
