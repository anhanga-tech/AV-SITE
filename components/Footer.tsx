                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex flex-col md:items-end gap-2 text-center md:text-right order-1 md:order-2">
                        <div className="text-xs text-gray-500 font-medium flex items-center justify-center md:justify-end gap-1">
                            Feito com <Heart className="w-3 h-3 text-red-500" weight="fill" aria-hidden="true" /> pela <img src={`${baseUrl}assets/LOGO ANHANGA TECH.svg`} alt="Anhangá.tech" width="80" height="16" loading="lazy" className="h-4 w-auto inline-block mx-1 align-sub" /> • {currentYear}
                        </div>
