        ...
        <section id="direitos-titulares" className="space-y-2">
            ...
            <div className="space-y-2 font-inter text-muted-foreground">
                ...
                <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong>Oposição:</strong> Oposição ao tratamento realizado com fundamento em qualquer hipótese de dispensa de consentimento, inclusive o legítimo interesse — como o tratamento analítico (Seção 9.4) e o de segurança e estabilidade do website (Seção 5.8) —, em caso de descumprimento da LGPD (Art. 18, § 2º);</li>
