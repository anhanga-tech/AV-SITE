        ...
        <section id="metodos-coleta" className="space-y-2">
            ...
            <div className="space-y-2 font-inter text-muted-foreground">
                ...
                <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong>Métricas de desempenho do website (Cloudflare Web Analytics):</strong> página visitada, página de origem, dados técnicos do navegador e indicadores de velocidade de carregamento, sem cookie e sem identificador que persista entre visitas. Servem para medir e corrigir problemas de desempenho, com base no legítimo interesse descrito na Seção 5.3.</li>
