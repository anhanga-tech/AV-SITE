...
- Nem todo apontamento de bot é válido: os dois já reclamaram de coisa que já estava correta **no próprio commit analisado**. Conferir contra o conteúdo real (`git show <commit>:<arquivo>`) antes de aceitar.
