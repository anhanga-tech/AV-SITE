  ...
  return (
    <>
      <SEO
        ...
        description="Planeje sua viagem para o Beto Carrero World 2026 com hotel, ingressos e transporte inclusos. Suporte especializado da Anhangá Viagens para uma experiência em família inesquecível."
